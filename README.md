...
* **Medium:** [Read on Medium](https://dulannithilaliyanarachchi.medium.com/a-complete-guide-to-install-xampp-configure-apache-mysql-services-and-deploy-wordpress-b6076092f948)
* **AWS:** [Read on AWS](https://builder.aws.com/content/3ImJ4y1l6v3vxDM6zoSjnTskHRi/a-complete-guide-to-install-xampp-configure-apache-and-mysql-services-and-deploy-wordpress-using-powershell-commands)
* **DEV Community:** [Read on DEV Community](https://dev.to/dulannithilaliyanarachchi/a-complete-guide-to-install-xampp-configure-apache-mysql-services-and-deploy-wordpress-using-3f0h)
...
<br>The powershell commands is also there in this repository as a seperate file with the name Powershell Commands.md
